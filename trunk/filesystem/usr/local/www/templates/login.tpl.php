        ...
        <script type="text/javascript">
            $(function() {
                $('#login_form').submit(function() {
                    ...
                    $.ajax({
                        url: gp.debug ? 'testxml/loginsuccess.xml' : 'ajaxserver.php',
                        type: 'POST',
                        ...
                        success: function(data) {
                            ...
                            if (!json || !json.action || json.action != 'login-ok') {
                                if (json.message) {
                                    gp.displayError(json.message, 'Login failed', $('#login_form_error'));
                                } else {
                                    gp.displayError('An unknown error occurred! Login failed.', 'Unknown error', $('#login_form_error'));
                                }
                            } else {
