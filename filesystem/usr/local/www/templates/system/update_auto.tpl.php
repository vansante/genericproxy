...
<script type="text/javascript">
    gp.system.update.auto.checkUpdates = function(auto_check) {
        gp.system.update.auto.resetForm();
        gp.doAction({
            ...
            successFn: function(json) {
                ...
                gp.system.update.auto.loadForm();
            }
        });
    };

    gp.system.update.auto.resetForm = function() {
        $('#system_update_auto_warning, #system_update_auto_form, #system_update_auto_no_update').hide();
    };

    gp.system.update.auto.loadForm = function() {
    ...
    $(function() {
        $('#system_update_auto_form').submit(function(){
            gp.confirm("Are you sure?", "Are you sure you want to update the devices firmware?", function() {
                gp.doFormAction({
        ...
        $('#system_update_auto_check_link').click(function() {
            gp.system.update.auto.checkUpdates(false);
            return false;
        });
    });
</script>